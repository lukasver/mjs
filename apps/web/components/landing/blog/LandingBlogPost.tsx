...
export const LandingBlogPost = ({
	...
	return (
		<div
			className={clsx(
				"flex group h-full bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-xs hover:shadow-md transition-shadow border border-gray-200 dark:border-gray-800",
		...
		>
			...
			>
				...
				<div className="flex flex-wrap justify-between gap-4 mt-auto pt-4">
					{readingTime && (
						<span className="shrink-0 text-sm text-gray-500 dark:text-gray-400 py-0.5">
