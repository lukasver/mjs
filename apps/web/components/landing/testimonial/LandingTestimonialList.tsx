			...
			{withBackgroundGlow ? (
				<>
					...
					>
						<div
							className={clsx(
								"ml-[max(50%,38rem)] aspect-1313/771 w-328.25 bg-linear-to-tr",
								backgroundGlowVariant === "primary"
					...
					>
						<div
							className={clsx(
								"ml-[-22rem] aspect-1313/771 w-328.25 flex-none origin-top-right rotate-30 bg-linear-to-tr xl:ml-0 xl:mr-[calc(50%-12rem)]",
								backgroundGlowVariant === "primary"
									? "from-primary-100 to-primary-200"
									: "",
								backgroundGlowVariant === "secondary"
