    ...
    <footer
      className={clsx(
        ...
        withBackgroundGradient
          ? 'from-gray-50/5 via-gray-100/60 to-gray-50/5 backdrop-blur-xs dark:from-slate-700/5 dark:via-slate-700/60 dark:to-slate-700/5'
          : '',
        className
      )}
    >
            ...
            <Link href='/'>
              {logoComponent || (
                <div className='flex items-center gap-3 justify-start'>
                  ...
                  <div className='hidden text-2xl font-semibold font-head sm:flex gap-2 h-full'>
