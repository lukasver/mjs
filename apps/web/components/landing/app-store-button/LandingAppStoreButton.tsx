...
export const LandingAppStoreButton = ({
	...
	return (
		<Button
			type="button"
			className={clsx(
				"p-0 relative inline-flex items-center justify-center cursor-pointer transition-opacity duration-200 hover:opacity-70 focus:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary-500",
				className,
			)}
