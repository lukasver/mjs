...
export const LandingProblemAgitator = ({
	...
	const rotationClassesThree = {
		0: "rotate-220 items-center -translate-y-[15px] -translate-x-[30px]",
		1: "-rotate-45 items-center -translate-y-[15px] translate-x-[30px]",
		2: "rotate-90 items-center justify-center translate-y-[60px]",
	};

	const rotationClassesFour = {
		0: "rotate-220 items-center -translate-y-[15px] -translate-x-[30px]",
		1: "-rotate-45 items-center -translate-y-[15px] translate-x-[30px]",
		2: "rotate-45 items-center translate-x-[30px] translate-y-[30px]",
		3: "rotate-120 items-center translate-y-[45px]",
	};
