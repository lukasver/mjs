    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn(
            'absolute z-30 -top-20 -right-20 lg:-right-40 lg:-top-40',
            className
          )}
        >
          <div className='px-8 py-4 relative bg-white/70 backdrop-blur-md border border-white/30 rounded-2xl shadow-2xl max-w-xs lg:max-w-sm'>
            <p className='text-gray-800 text-xl xl:text-2xl font-medium'>
              {message}
            </p>
