  ...
  return (
    <div className='flex flex-col w-full items-center fancy-overlay'>
      ...
      <div className='w-full flex flex-col items-center mb-24'>
        ...
        <div className='mt-20 max-w-(--breakpoint-md) mx-auto bg-white dark:bg-black w-full rounded-sm shadow-md p-6 mb-8'>
        ...
        <div className='max-w-(--breakpoint-md) mx-auto bg-white dark:bg-black w-full rounded-sm shadow-md p-6 mb-8'>
