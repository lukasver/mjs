 ...
 * Shows pending message, project name, support email, and transaction link if available.
 */
const Pending = () => {
  ...
  return (
    <div className='flex items-center justify-center min-h-[80vh] p-4'>
      <Card className='w-full max-w-xl flex flex-col items-center gap-6 bg-gradient-to-t from-[#fffbc9] to-[#f7f9f9] border-none shadow-xl rounded-xl'>
