...
const getComputedStyleValue = (variable: string): string => {
...
const TEXT_COLORS: BubbleColorMenuItem[] = [
  ...
  {
    name: 'Primary',
    color: getComputedStyleValue('--primary'),
  },
  {
    name: 'Secondary',
    color: getComputedStyleValue('--secondary'),
  },
  {
    name: 'Accent',
    color: getComputedStyleValue('--accent'),
  },
  {
    name: 'Red',
    color: '#E00000',
